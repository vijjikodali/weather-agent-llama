...
# ----- HEADER WITH PHOTO - ERROR PROOF -----
col1, col2 = st.columns([1, 4])
with col1:
    # Try photo.jpg first, fallback to GitHub avatar if it fails
...
st.divider()
st.caption("Made with Streamlit + Databricks + OpenWeather | Built by Vijayalaxmi Kodali")    city_map = {
        "singapore": "Singapore,SG",
        "hyderabad": "Hyderabad,IN",
        "mumbai": "Mumbai,IN",
        "delhi": "Delhi,IN"
